...
MODALITY_META = {
    "body": {
        "toml": Path("modalities/body/config/inference_config_body.toml"),
        "ckpt": "modalities/body/checkpoints/body/clip_body_mamba_transformer_fusion_model.pt",
    },
    "face": {
        "toml": Path("modalities/body/config/inference_config_face.toml"),
        "ckpt": "modalities/body/checkpoints/face/clip_face_mamba_transformer_fusion_model.pt",
    },
}
